...
class yc_song_example_jukebox__jukebox_library_artist_album_song(PybindBase):
  ...
  album resource, within the jukebox library.
    """
    __slots__ = (
    '_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name', '__location', '__format',
    '__length',)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__name = YANGDynClass(
            base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1 .. max']}), is_leaf=True,
            yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods,
            register_paths=True, is_keyval=True, namespace='http://example.com/ns/example-jukebox',
            defining_module='example-jukebox', yang_type='string')
    ...
    media file for the song
        """
        try:
            t = YANGDynClass(v, base=unicode, is_leaf=True, yang_name="location", parent=self,
                             path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='string')
        except (TypeError, ValueError):
    ...
    'location' leaf for this entry.
        """
        try:
            t = YANGDynClass(v, base=unicode, is_leaf=True, yang_name="format", parent=self,
                             path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='string')
        except (TypeError, ValueError):
    ...
    def _set_length(self, v, load=False):
        ...
        """
        try:
            t = YANGDynClass(v, base=np.uint32, is_leaf=True, yang_name="length", parent=self,
                             path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='uint32')
        except (TypeError, ValueError):
  ...
  artist resource, within the jukebox library.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__genre = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_type="dict_key",
                                    ...
                                    namespace='http://example.com/ns/example-jukebox',
                                    defining_module='example-jukebox', yang_type='identityref')
        self.__admin = YANGDynClass(base=yc_admin_example_jukebox__jukebox_library_artist_album_admin,
                                    is_container='container', yang_name="admin", parent=self,
                                    path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True,
                                    namespace='http://example.com/ns/example-jukebox',
        ...
        self.__year = YANGDynClass(
            ...
            yang_name="year", parent=self, path_helper=self._path_helper, extmethods=self._extmethods,
    ...
    def _set_year(self, v, load=False):
        ...
        """
        try:
            t = YANGDynClass(v, base=RestrictedClassType(base_type=np.uint16,
                                                         restriction_dict={'range': [u'1900 .. max']}), is_leaf=True,
                             yang_name="year", parent=self, path_helper=self._path_helper, extmethods=self._extmethods,
                             register_paths=True, namespace='http://example.com/ns/example-jukebox',
                             defining_module='example-jukebox', yang_type='uint16')
        except (TypeError, ValueError):
            raise ValueError({
    ...
    def _set_admin(self, v, load=False):
        ...
        """
        try:
            t = YANGDynClass(v, base=yc_admin_example_jukebox__jukebox_library_artist_album_admin,
    ...
    album resource, within the jukebox library.
        ...
        try:
            t = YANGDynClass(v, base=YANGListType("name", yc_song_example_jukebox__jukebox_library_artist_album_song,
                                                  yang_name="song", parent=self, is_container='list',
                                                  user_ordered=False, path_helper=self._path_helper, yang_keys='name'),
                             is_container='list', yang_name="song", parent=self, path_helper=self._path_helper,
                             extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='list')
        except (TypeError, ValueError):
  ...
  jukebox library resource.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__album = YANGDynClass(
            base=YANGListType("name", yc_album_example_jukebox__jukebox_library_artist_album, yang_name="album",
                              parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper,
                              yang_keys='name'), is_container='list', yang_name="album", parent=self,
            path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True,
            namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox', yang_type='list')
        self.__name = YANGDynClass(
            base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1 .. max']}), is_leaf=True,
    ...
    artist resource, within the jukebox library.
        ...
        try:
            t = YANGDynClass(v, base=YANGListType("name", yc_album_example_jukebox__jukebox_library_artist_album,
                                                  yang_name="album", parent=self, is_container='list',
                                                  user_ordered=False, path_helper=self._path_helper, yang_keys='name'),
                             is_container='list', yang_name="album", parent=self, path_helper=self._path_helper,
                             extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='list')
        except (TypeError, ValueError):
...
class yc_library_example_jukebox__jukebox_library(PybindBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__artist = YANGDynClass(
            base=YANGListType("name", yc_artist_example_jukebox__jukebox_library_artist, yang_name="artist",
                              parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper,
                              yang_keys='name'), is_container='list', yang_name="artist", parent=self,
            path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True,
            namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox', yang_type='list')
    ...
    jukebox library resource.
        """
        try:
            t = YANGDynClass(v, base=YANGListType("name", yc_artist_example_jukebox__jukebox_library_artist,
                                                  yang_name="artist", parent=self, is_container='list',
                                                  user_ordered=False, path_helper=self._path_helper, yang_keys='name'),
                             is_container='list', yang_name="artist", parent=self, path_helper=self._path_helper,
                             extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='list')
        except (TypeError, ValueError):
...
class yc_song_example_jukebox__jukebox_playlist_song(PybindBase):
    ...
    def _set_index(self, v, load=False):
        ...
        try:
            t = YANGDynClass(v, base=np.uint32, is_leaf=True, yang_name="index", parent=self,
                             path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True,
                             is_keyval=True, namespace='http://example.com/ns/example-jukebox',
                             defining_module='example-jukebox', yang_type='uint32')
        except (TypeError, ValueError):
...
class yc_playlist_example_jukebox__jukebox_playlist(PybindBase):
    ...
    def _set_song(self, v, load=False):
        ...
        """
        try:
            t = YANGDynClass(v, base=YANGListType("index", yc_song_example_jukebox__jukebox_playlist_song,
                                                  yang_name="song", parent=self, is_container='list', user_ordered=True,
                                                  path_helper=self._path_helper, yang_keys='index'),
                             is_container='list', yang_name="song", parent=self, path_helper=self._path_helper,
                             extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='list')
...
class yc_player_example_jukebox__jukebox_player(PybindBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if extmethods is False:
            ...
            self._extmethods = False
        self.__gap = YANGDynClass(
            base=RestrictedClassType(base_type=Decimal, restriction_dict={'range': [u'0.0 .. 2.0']}), is_leaf=True,
            yang_name="gap", parent=self, path_helper=self._path_helper, extmethods=self._extmethods,
            register_paths=True, namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
            yang_type='decimal64')
    ...
    def _set_gap(self, v, load=False):
        ...
        try:
            t = YANGDynClass(v,
                             base=RestrictedClassType(base_type=Decimal, restriction_dict={'range': [u'0.0 .. 2.0']}),
...
class yc_jukebox_example_jukebox__jukebox(PybindBase):
  ...
  and a play operation.
    ...
    def _set_playlist(self, v, load=False):
        ...
        """
        try:
            t = YANGDynClass(v, base=YANGListType("name", yc_playlist_example_jukebox__jukebox_playlist,
                                                  yang_name="playlist", parent=self, is_container='list',
                                                  user_ordered=False, path_helper=self._path_helper, yang_keys='name'),
                             is_container='list', yang_name="playlist", parent=self, path_helper=self._path_helper,
                             extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
    ...
    def _set_player(self, v, load=False):
        ...
        """
        try:
            t = YANGDynClass(v, base=yc_player_example_jukebox__jukebox_player, is_container='container',
                             yang_name="player", parent=self, path_helper=self._path_helper,
                             extmethods=self._extmethods, register_paths=True,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='container')
...
class yc_input_example_jukebox__example_jukebox_rpc_play_input(PybindBase):
    ...
    def _set_playlist(self, v, load=False):
        ...
        """
        try:
            t = YANGDynClass(v, base=unicode, is_leaf=True, yang_name="playlist", parent=self,
                             path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False,
                             namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                             yang_type='string')
        except (TypeError, ValueError):
...
class yc_example_jukebox_example_jukebox__example_jukebox_rpc(PybindBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if extmethods is False:
            ...
            self._extmethods = False
        self.__play = YANGDynClass(base=yc_play_example_jukebox__example_jukebox_rpc_play, is_leaf=True,
                                   yang_name="play", parent=self, path_helper=self._path_helper,
                                   extmethods=self._extmethods, register_paths=False,
                                   namespace='http://example.com/ns/example-jukebox', defining_module='example-jukebox',
                                   yang_type='rpc')
